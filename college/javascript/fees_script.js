function getInputValue(){
    ...
    if(inputVal==2){
        document.getElementById("demo").innerHTML ="Samhitha kancherla";
    ...
    {
        document.getElementById("demo").innerHTML ="santholin furtado";
        document.getElementById("demo1").innerHTML ="10000";   
    }

    else if(inputVal==4)
    {
        document.getElementById("demo").innerHTML ="Shreyas Patil";
        document.getElementById("demo1").innerHTML ="10000";   
    }
    else if(inputVal==5)
    {
        document.getElementById("demo").innerHTML ="shreya k ";
        document.getElementById("demo1").innerHTML ="10000";   
    }
    else if(inputVal==6)
    {
        document.getElementById("demo").innerHTML ="Renganayaki";
